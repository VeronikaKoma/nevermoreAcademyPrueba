<div class="headerBox">
    <div class="logoMolecule">
        <img src="img/nevermoreLogo.png" class="logo" alt="Nevermore Academy Logo">
        <a class="navbar-brand headerTitle" href="{{ url('/') }}">
            Nevermore Academy
        </a>
    </div>
    ...
    @guest
        ...
        @if (Route::has('register'))
            <li class="nav-item">
                <a class="nav-link registerBtn" href="{{ route('register') }}">{{ __('Register') }}</a>
            </li>
            @endif
    @else
